...
public class InsertionSort {
    ...
    public void parallelSort(int nThreads) throws InterruptedException{
        long inicio = System.nanoTime();
        ...
        insertionParts(partSize,nThreads);
        long fim = System.nanoTime();
        this.time_paralelo = fim - inicio;
    }
    private void insertionParts(int partSize,int nThreads){
        for(int t = 0; t <nThreads; t++){
