...
public class InsertionSort implements SortingAlgorithm {
    ...
    public int[] OpThreads =  {2,4,5,10,100,1000,10000};
    ...
    //     TreeMap<Integer, Long> Map = new TreeMap<>(mapTimes);
    ...
    //     throw new UnsupportedOperationException("Unimplemented method 'printarFinalMap'");
    // }
