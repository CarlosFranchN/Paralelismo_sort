...
public class QuicksSort implements SortingAlgorithm {
        ...
        public void gerandoTeste() {
            try {
                ...
                gerarTesteParalelo();
                        ...
                        private void gerarTesteParalelo() {
                            // TODO Auto-generated method stub
                            throw new UnsupportedOperationException("Unimplemented method 'gerarTesteParalelo'");
                        }
    ...
    public void gerarTestesParalelo(int nThreads) {
        long startTime = System.nanoTime(); // Início do tempo
    ...
    public static void main(String[] args) {
        ...
        quickSort.gerarTestesParalelo(2);
