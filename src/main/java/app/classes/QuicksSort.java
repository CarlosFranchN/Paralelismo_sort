...
public class QuicksSort implements SortingAlgorithm {
    ...
    public void gerarTesteSerial(){
        ...
        QuicksSort task = new QuicksSort(this.array, high, low, nThreads);
        task.serial();
    ...
    public void gerarTesteParalelo(){
        ...
        for (int t : numThreads) {
            QuicksSort task = new QuicksSort(array, high, low, t);
            task.paralelo();
            String key = String.format("QuickSortParalelo%d", t);
